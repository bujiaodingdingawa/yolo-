...
class StereoDepth(object):
    ...
    def __init__(self, stereo_file, width=1280, height=960, filter=False, use_open3d=True, use_pcl=False):
        """
...
def get_parser():
    stereo_file = "configs/me/stereo_cam.yml"
    left_video = 0 # 对应左路摄像头ID
    right_video = None  # 对应右路摄像头ID
    left_file = "configs/me/left_cam.yml"
    right_file = "configs/me/right_cam.yml"
